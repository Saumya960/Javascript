...
// Add your code here to create and append articles to the section
...
function createArticle(articleData) {
  ...
  // Add event listener to open modal with large image
  article.addEventListener('click', function () {
    openModal(articleData.image.large, articleData.title); // Open modal with large image
  });

  // Append the children elements to the article
...
function openModal(imageSrc, altText) {
  ...
  const closeButton = modal.querySelector('span'); // Ensure close button reference

  modalImage.src = imageSrc;
  modalImage.alt = altText;

  // Ensure the close button is visible and functional
  closeButton.style.display = 'block'; // Ensure close button is visible (it may be hidden)
